...
public class ChartExamples extends JFrame
{
  ...
  public ChartExamples()
  {
	...
	getContentPane().add(xMin, gridConstraints);
	
    xMax.setText("xMax");
    xMax.setColumns(5);
	gridConstraints.gridx = 1;
	gridConstraints.gridy = 5;
	getContentPane().add(xMax, gridConstraints);
	
    yMin.setText("yMin");
    yMin.setColumns(5);
	gridConstraints.gridx = 2;
	gridConstraints.gridy = 5;
	getContentPane().add(yMin, gridConstraints);
	
    yMax.setText("yMax");
    yMax.setColumns(5);
	gridConstraints.gridx = 3;
	gridConstraints.gridy = 5;
	getContentPane().add(yMax, gridConstraints);
	
	setButton.setText("Set Dimensions");
	setButton.setPreferredSize(new Dimension(200, 25));
    gridConstraints = new GridBagConstraints();
    gridConstraints.gridx = 1;
    gridConstraints.gridy = 6;
    gridConstraints.gridwidth = 2;
 //   gridConstraints.insets = new Insets(5, 5, 5, 5);
    getContentPane().add(setButton, gridConstraints);
